...
def wolf_elk_portrayal(agent):
    ...
    if type(agent) is Elk:
        portrayal["Shape"] = "wolf_sheep/resources/sheep.png" # download file from resources CHANGE
        portrayal["scale"] = 0.9
        portrayal["Layer"] = 1
...
canvas_element = mesa.visualization.CanvasGrid(wolf_elk_portrayal, 50, 50, 500, 500)
